              ...
              <tbody>
                {displayedUsers.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="flex flex-col sm:flex-row gap-2 px-6 py-4">
                        <Link
                            className="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                            to={`/iuran/list/${item.uuid}`}
                          >
                            Lihat Kartu Iuran
                          </Link>
                        {/* {user && (user?.role?.name === "admin" || user?.role?.name === "Bendahara") ? (
                        <>
                          <Link
                            className="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                            to={`/iuran/list/${item.uuid}`}
